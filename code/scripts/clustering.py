...
# ============================================================
# PLOT OPCIONAL (se usa para almacenamiento, no para logging)
# ============================================================

def plot_graph(G, communities, title, folder, filename):
...
# ============================================================
# EJECUCIÓN PÚBLICA (pipeline)
# ============================================================

def ejecutar_clustering(modo: str, score: int):
    print(f"• Clustering (G / GN / I)...", end="")
