...
En primer lugar, se recopiló la lista de genes asociados al fenotipo de interés. Para hacerlo, se adoptaron dos vías distintas: por un lado, se utilizaron los genes encontrados tras una revisión bibliográfica manual (\autoref{tab:genes_introduccion}, 35 genes); por el otro, se extrajeron  a partir de la API de la HPO (49 genes). Los 35 genes de la primera estrategia (la cual, a lo largo del trabajo, será referida como "manual") están contenidos dentro de los 49 genes de la segunda.
