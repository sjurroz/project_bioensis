...
\begin{table}[h!]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\textbf{ID} & \textbf{\textit{Edge Betweenness}} & \textbf{\textit{Infomap}} & \textbf{\textit{Fast Greedy}} \\ \hline
...
En la figura 6 podemos comparar los resultados obtenidos anteriormente con los obtenidos de forma manual. De forma análoga a como se realizó en para el HPO.
...
En la figura --- se aprecia de forma gráfica la red de nodos asociados de forma manual. 
